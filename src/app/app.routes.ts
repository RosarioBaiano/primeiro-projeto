...
import { DiretivesComponent } from './diretives/diretives.component';
...
export const routes: Routes = [
    ...
    {path: 'directives', title:'Directives', component: DiretivesComponent},
    {path: 'customers', title:'Customers', component: CustomerListComponent},
    {path: 'customer/:id', title: 'Dustomer Details', component: CustomerDetailsComponent},
